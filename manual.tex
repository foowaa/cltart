...
\subsection{参考文献格式}
\par 默认使用GBT-7714格式，如想使用IEEE Trans格式，请传入bibieee参数。cltart对IEEEbib.bst做了一些更改，使之可以产生和IEEE Trans上一样的参考文献格式而不必引入IEEETrans.cls。注意：IEEE Trans格式比较适用于参考文献为英文论文，否则不要使用。
